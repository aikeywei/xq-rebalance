...
- `easytrader` 针对用户在电脑网页版组合名称旁边或地址栏 `/P/ZH...` 里看到的组合代码，读取持仓或提交调仓。
...
- 指导用户找组合代码时，要求用户用电脑浏览器登录雪球，打开自己的组合页面，看组合名称旁边的 `ZH...`；如果页面没有明显显示，就看地址栏 `/P/ZH...`。
...
如果用户问“怎么安装这个 Skill”“CLI 怎么用”“是不是 npx”“能不能像别的 skills 一样安装”，先读：

- `references/install-as-codex-skill.md`
